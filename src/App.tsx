    ...
    <div style={bg}>
      ...
      <div style={{position:"relative",zIndex:1,width:"100%",maxWidth:380}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:14}}>
          ...
          <button onClick={()=>onAuth({id:"guest",email:"guest",isGuest:true})} style={{padding:"11px",borderRadius:11,border:`1px solid ${D.gb}`,background:"transparent",cursor:"pointer",color:D.mt,fontSize:12}}>{t.gb3}</button>
        </div>
